...
**Scope note.**
27 components: the original 7 basics
...
drag-and-drop file attachment), and **Dropdown** (a trigger+panel in
Single select/Multiple select variants — the former, separately
transcribed **Select** and designed-from-scratch **MultiSelect**,
consolidated into one component). The Stat/KPI card
batch, App Shell, Stepper, FileUploader, Dropdown, and Search input
...
- **v0.9.20 — 2026-08-06** — Fixed a font-token mismatch in
  **Dropdown**'s Dropdown Option row sub-component, both variants:
  ...
  the mismatch being fixed. Net component count unchanged (still 27).

- **v0.9.19 — 2026-08-06** — Rebuilt **Dropdown**'s Single select
  ...
  unchanged (still 27) — this reshapes Single select's own container,
  it doesn't add or remove a component.

- **v0.9.18 — 2026-08-06** — Rebuilt **Dropdown**'s Multiple select
  ...
  unchanged (still 27) — this reshapes Multiple select's own surface,
  it doesn't add or remove a component.

- **v0.9.17 — 2026-08-06** — Expanded **Dropdown**'s Single select
  ...
  Net component count unchanged (still 27) — this reshapes Single
  select's own state/style surface, it doesn't add or remove a
  component.

- **v0.9.16 — 2026-08-06** — Consolidated **Select** and **MultiSelect**
  ...
  Net component count: 28 → 27 (two merged into one, same accounting
