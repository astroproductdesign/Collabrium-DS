...
**v0.9.58** — 2026-08-24 — Sourced from the Collabrium brand deck
...
Reuses [Prompt input bar](#prompt-input-bar)'s own glow mechanism
...
| Icon | `ph-fill ph-sparkle` — the same glyph as [Prompt input bar](#prompt-input-bar)'s AI mark, fixed Neutral-9 (not animated) — a bare Tier 2 Fill icon like every other tone, not the mark's circular Primary-fill badge |
...
- **v0.9.58 — 2026-08-24** — Added an **AI Recommendation** tone to
  [Info Banner](#info-banner), and demoed it in `preview.html`/
  `components.css`. Reuses [Prompt input bar](#prompt-input-bar)'s own
